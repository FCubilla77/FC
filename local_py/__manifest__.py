# -*- coding: utf-8 -*-
{
    ...
    "data": [
        ...
        "data/local_py_concepto_iva_data.xml",
        "data/local_py_concepto_renta_no_residente_data.xml",
        "data/local_py_tipo_fiscal_data.xml",
        "data/local_py_orden_pago_sequence.xml",
        "data/local_py_tesaka_import_sequence.xml",
        "views/res_partner_views.xml",
        "views/local_py_cuenta_corriente_move_line_views.xml",
        ...
        "views/local_py_cheque_cliente_views.xml",
        "views/local_py_recibo_views.xml",
        "views/local_py_recibo_anular_wizard_views.xml",
        ...
        "views/local_py_report_recibo_listado.xml",
        "views/local_py_reporte_recibo_wizard_views.xml",
        "views/local_py_report_retenciones_listado.xml",
        "views/local_py_reporte_retenciones_wizard_views.xml",
        "views/local_py_documento_anulado_views.xml",
        ...
        "views/local_py_retencion_recibida_views.xml",
        "views/local_py_concepto_iva_views.xml",
        "views/local_py_concepto_renta_no_residente_views.xml",
        "views/local_py_tesaka_export_wizard_views.xml",
        "views/local_py_tesaka_import_views.xml",
        "views/local_py_retencion_anular_wizard_views.xml",
